                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4>
                                        <span class="<?php echo $mostrar['imagen'];?>">
                                        </span>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Color: <?php echo $mostrar['color']?>
                                        </li>
                                        <li>
                                            Memoria: <?php echo $mostrar['memoria']?>
                                        </li>
                                        <li>
                                            Disco Duro: <?php echo $mostrar['discoDuro']?>
                                        </li>
                                        <li>
                                            Procesador: <?php echo $mostrar['procesador']?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
